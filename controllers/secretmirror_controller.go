...
//+kubebuilder:rbac:groups=v1,resources=secrets,verbs=get;create;update
...
func (r *SecretMirrorReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		if errors.IsNotFound(err) {
			err := r.deleteSecret(secretMirror)
			if err != nil {
...
func (r *SecretMirrorReconciler) deleteSecret(secretMirror *secretv1alpha1.SecretMirror) error {
	return nil
}
